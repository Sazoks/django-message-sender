...
class AbstractSender(ISendable, IModuleInformative, ABC):
    """Абстрактный класс отправителя данных"""
    
    default_message_builder_class = DefaultMessageBuilder
    ...
    def send(self, message_dao: BaseMessageDAO) -> None:
        ...
        :raise: Exception в случае любой ошибки отправки данных.
        """
